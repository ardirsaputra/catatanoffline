      ...
      body: ListView(
        ...
        children: [
          ...
          _ChoiceTile(
            ...
            onChanged: (v) =>
                ref.read(settingsProvider.notifier).setDefaultView(v),
          ),
          _ChoiceTile(
            title: 'Ukuran Kartu',
            ...
            onChanged: (v) =>
                ref.read(settingsProvider.notifier).setCardSize(v),
          ),
          _ChoiceTile(
            title: 'Ukuran Font',
          ...
          _SwitchTile(
            ...
            onChanged: (v) =>
                ref.read(settingsProvider.notifier).setShowMetadata(v),
          ),
          ...
          _ChoiceTile(
            ...
            onChanged: (v) =>
                ref.read(settingsProvider.notifier).setDefaultBackground(v),
          ),
          _ChoiceTile(
            ...
            onChanged: (v) => ref
                ...
                .setAutoSaveInterval(int.parse(v)),
          ),
          ...
          // ── Tentang ──────────────────────────────────────────────────
          _SectionHeader(title: 'Tentang', icon: 'ℹ️'),
          ListTile(
            leading: const Icon(Icons.info_outline),
            title: const Text('Versi Aplikasi'),
            subtitle: const Text('BerkasKu v1.0.0'),
            trailing:
            ...
            children: presets.map((p) {
              ...
              return Padding(
                ...
                child: GestureDetector(
                  onTap: () =>
                      ref.read(settingsProvider.notifier).setTheme(p.key),
                  child: Tooltip(
                    message: p.label,
              ...
              trailing: Row(
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () =>
                        _showCategoryForm(context, watchRef, cat),
                  ),
                  IconButton(
  ...
  Future<void> _deleteCategory(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
            'Kategori "${cat.name}" akan dihapus. Berkas terkait tidak akan terhapus.'),
        actions: [
          TextButton(
...
class _ColorSwatches extends StatelessWidget {
  ...
  static const _colors = [
    '#A8D8EA', '#C9B8E8', '#B5EAD7', '#FFDFD3', '#FFB7C5',
    '#FFF9C4', '#D7E8BA', '#B8D4E8', '#F5C6CB', '#D4E6F1',
    '#E8D5B7', '#C8E6C9', '#F8BBD9', '#B2DFDB', '#E1BEE7',
  ];
